...
if __name__ == "__main__":
    datadir = "/beegfs/jl7003/deltaVinaXGB_develop/Test_CASF_2013/Docking/"
    ...
    for n in ["65_correct"]:
        for i in ["C","Co"]:
            score_dir = datadir + "our_score_" + i + "_final_model" + n 
            score_dir = datadir + "Vina_" + i + "_final"
            #score_dir = datadir + "GOLD-ChemPLP"
