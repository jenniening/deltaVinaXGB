...
def get_infor(datadir, pdbfile, features, file_type):
    # obabel water
    os.system(chimera + " --nogui --silent --script 'get_Crw_obabelwater.py " + datadir + " " + pdbfile + " " + file_type + "'")
    ...
    if len(features) == 5:
        os.system(python + " cal_vina58.py " + datadir + " " + pdbfile + " " + file_type )
        print("Finish Vina")
        os.system(python + " cal_sasa.py " + datadir + " " + pdbfile + " " + file_type)
        print("Finish SASA")
        os.system(python + " cal_dERMSD_correct.py " + datadir + " " + pdbfile + " " + file_type)
        print("Finish ligand stability features")
        # obabel water
        os.system(chimera + " --nogui --silent --script 'cal_bw_obabelwater.py " + datadir + " " + pdbfile + " " + file_type + "'")

        #os.system(chimera + " --nogui --silent --script 'cal_bw.py " + datadir + " " + pdbfile + " " + file_type + "'")
        print("Finish BW")
        os.system(chimera + " --nogui --silent --script 'cal_ion.py " + datadir + " " + pdbfile + " " + file_type + "'")
        print("Finish Ion")
        combine(datadir)
...
#    print("features will be calcualted: " + ",".join(features))
    ...
    get_output([test_new1,outRF1,test_new2,outRF2, test_new3,outRF3],datadir, outfile)
